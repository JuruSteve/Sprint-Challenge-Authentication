...
bcrypt uses hashing algorithm to hash sensitive information like a password multiple times(rounds) so it's hard for attackers to obtain it.

1. What does bcrypt do to slow down attackers?

bcrypt implements salting after hashing the password which requires the attacker to have the hash, know the algorithm used and how many rounds were used to generate the hash in the first place

1. What are the three parts of the JSON Web Token?

a JSON web token consists of the header, payload and the signature
